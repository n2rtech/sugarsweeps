...
class GamingRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.gaming-requests.list', compact('requests', 'filter_box', 'filter_name', 'filter_date', 'filter_username', 'filter_status', 'filter_game', 'platforms'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gaming-requests.edit', compact('request', 'other_requests'));
    }
    ...
    {
        $rules = [
            'username'          => ['required', 'unique:gaming_accounts,username,' . $id],
            'password'          => 'required',
        ];
        ...
        if($gaming_account_exists){
            ...
            return redirect()->route('admin.gaming-requests.index')->with('success', 'Player Account Updated successfully');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.gaming-requests.index')->with('success', 'Request deleted successfully');
    }
}
