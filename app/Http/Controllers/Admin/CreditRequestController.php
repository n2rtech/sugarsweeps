...
class CreditRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.deposit-requests.list', compact('requests', 'filter_name', 'filter_phone', 'filter_cashier', 'filter_platform', 'filter_status', 'filter_box', 'cashiers', 'platforms'));
    }
