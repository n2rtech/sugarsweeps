...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@git.n2rtechnologies.com:rc21292/jayscasino.git',
    ],
    ...
    */
    ...
    'hosts' => [
        '216.158.229.197' => [
            'stage' => 'staging',
            'deploy_path' => '/var/www/jayscasino',
            'user' => 'root',
            ...
            'shared_dirs' => [ "storage" ] ,
            'shared_files' => [ ".env", "robots.txt" ],
            'composer_options' => 'install --ignore-platform-reqs'
        ],
    ],
