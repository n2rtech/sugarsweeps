    ...
    <nav class="navbar ms-navbar">
        ...
        <div class="logo-sn logo-sm ms-d-block-sm">
          <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="{{ route('cashier.dashboard')}}"><img src="{{ asset('assets/img/Logo.png') }}" alt="Logo" class="img-responsive"> </a>
        </div>
        ...
        <li class="ms-nav-item dropdown notification-list">
          ...
          <li class="ms-nav-item ms-nav-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
              <li class="dropdown-menu-header">
                <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome {{Auth::guard('cashier')->user()->firstname}} {{Auth::guard('cashier')->user()->lastname}}</span></h6>
              </li>
              <li class="dropdown-divider"></li>
              <li class="ms-dropdown-list">
                <a class="media fs-14 p-2" href="{{route('cashier.my-account.edit', Auth::guard('cashier')->id())}}"> <span><i class="flaticon-gear mr-2"></i> My Account</span> </a>
              </li>
              <li class="dropdown-menu-footer">
                <a class="media fs-14 p-2" href="{{route('cashier.password.form')}}"> <span><i class="flaticon-security mr-2"></i> Change Password</span> </a>
              </li>
              <li class="dropdown-divider"></li>
              ...
              <li class="dropdown-menu-footer">
                ...
                <form id="logout-form" action="{{ 'App\Models\Cashier' == Auth::getProvider()->getModel() ? route('cashier.logout') : route('logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>
              </li>
            </ul>
