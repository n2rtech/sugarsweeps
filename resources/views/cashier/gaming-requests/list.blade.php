                ...
                <div class="ms-panel-body">
                    <div class="row">
                        <div class="col-md-12 mb-4" id="filterBox">
                            <form action="{{ route('cashier.gaming-requests.index') }}">
                                <div class="form-row">
                                    ...
                                    <div class="col-xl-2 col-md-12 text-right">
                                        ...
                                        <a href="{{ route('cashier.gaming-requests.index') }}" class="ms-btn-icon btn-gradient-warning form-control" type="submit"><i class="fas fa-undo"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@push('scripts')
    ...
    <script>
        $(document).on("click", ".confirmDelete", function(e) {
            ...
            form_action = '{{ route('cashier.gaming-requests.destroy', ':id') }}';
