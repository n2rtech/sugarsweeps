...
<head>
    ...
    <meta name="description"
        content="Forgot Password | Cashier">
    <meta name="keywords"
        content="Cashier Forgot Password">
    <meta name="author" content="PIXINVENT">
    <title>Forgot Password | Cashier</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{ asset('assets/images/pages/forgot-password.png') }}" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Enter your email address and we'll send you an email with instructions to reset your password.</p>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('cashier.password.email') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    <div class="row pt-2">
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <a href="{{ route('cashier.login') }}" class="btn btn-outline-primary btn-block px-0">Go Back to Login</a>
                                                        </div>
                                                        <div class="col-12 col-md-6 mb-1">
