    ...
    <div class="col-md-12">
        <div class="ms-panel">
            ...
            <div class="ms-panel-body">
                <form class="form-horizontal" id="accountForm" action="{{route('cashier.my-account.update', $cashier->id)}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row mb-3">
						...
						<div class="col-9">
							<input type="text" id="firstname" name="firstname" class="form-control" value="{{$cashier->firstname}}">
							@error('firstname')
                    ...
                    <div class="form-group row mb-3">
						...
						<div class="col-9">
							<input type="text" id="lastname" name="lastname" class="form-control" value="{{$cashier->lastname}}">
							@error('lastname')
							<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
							</span>
					...
					<div class="form-group row mb-3">
						...
						<div class="col-9">
							<input type="email" id="email" name="email" class="form-control" placeholder="Email" value="{{$cashier->email}}">
							@error('email')
							<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
							</span>
					...
					<div class="form-group row mb-3">
						...
						<div class="col-9">
							<input type="text" id="phone" name="phone" class="form-control" value="{{$cashier->phone}}">
						</div>
					</div>
					...
					<div class="form-group row mb-3">
						...
						<div class="col-9">
							...
							@endif
							<img id="preview_img" src="{{$cashier->avatar}}" class="mt-2" width="150" height="150"/>
						</div>
					</div>
