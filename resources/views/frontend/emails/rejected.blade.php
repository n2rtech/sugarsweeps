        ...
        <tr style="height: 165px;">
          <td align="center" style="border: none;
            ...
            <p style="font-weight: bolder;font-size: 42px;
                                ...
                                color:#B90A5B;font-family: system-ui;"> We are Sorry! <br>
        ...
        <tr>
          <td style="height: 150px;
            ...
            <h2 style="text-align: center;
                                 align-items: center;font-family: system-ui;"> Your account review is completed now! </h2>
            <p class="data" style="text-align: center;
                                align-items: center;
                                font-size: 15px;
                                padding-bottom: 12px;font-family: system-ui;"> You account has been rejected. Please contact Administrator for more information</p>
            <p style="text-align: center">
              <a href="{{ route('index') }}" style="text-decoration: none;
                                    color:black;
                                    border: 2px solid #A80033;
                                    padding: 10px 30px;
                                    font-weight: bold;font-family: system-ui;"> Contact </a>
            </p>
          </td>
        </tr>
