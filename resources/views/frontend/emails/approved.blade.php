        ...
        <tr style="height: 165px;">
          <td align="center" style="border: none;
            ...
            <p style="font-weight: bolder;font-size: 42px;
                                ...
                                color:#B90A5B;font-family: system-ui;"> Congratulations! <br>
        ...
        <tr>
          <td style="height: 150px;
            ...
            <p class="data" style="text-align: center;
                                align-items: center;
                                font-size: 15px;
                                padding-bottom: 12px;font-family: system-ui;"> You account has been approved. Please login to continue</p>
