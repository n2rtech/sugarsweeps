        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="ms-panel-custom">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Privacy Page</li>
                </ol>
            </nav>
        </div>
        <div class="col-md-12">
                ...
                <div class="ms-panel-body">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <form action="{{ route('admin.save-privacy-setting') }}" method="POST" id="paymentForm" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="content" placeholder="Content"
                                            name="content" rows="10">{{ old('content', $privacy['content']) }}</textarea>
                                        @error('content')
