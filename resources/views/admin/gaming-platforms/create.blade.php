    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Create Gaming Platform</h2>
                </div>
            </div>
        </div>
    </div>
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.gaming-platforms.store') }}" method="POST" id="gamingForm"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="download_link" placeholder="Download Link"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @endif
                                <img id="preview_img" src="https://via.placeholder.com/244" class="mt-2" width="120"
                                    height="120" />
                            </div>
                        </div>
