    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" class="ms-panel-custom">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Gaming Platform</li>
            </ol>
        </nav>
    </div>
    <div class="col-md-12">
            ...
            <div class="ms-panel-body">
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <form action="{{ route('admin.gaming-platforms.update', $platform->id) }}" method="POST" id="paymentForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="download_link" placeholder="Game Download Link"
                                        name="download_link" value="{{ old('download_link', $platform->download_link) }}">
                                    @error('download_link')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @endif
                                    <img id="preview_img" src="{{ $platform->image }}" class="mt-2" width="120" height="120"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <label class="ms-switch">
                                        <input type="checkbox" id="statuses" name="status" value="1" @if(old('status' , $platform->status) == 1) checked @endif>
