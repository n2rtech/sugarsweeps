    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Gaming Platforms</h2>
                </div>
            </div>
        </div>
            ...
            <div class="form-group breadcrum-right">
                <div class="dropdown">
                    <a class="btn btn-dark btn-md waves-effect waves-light"
                        href="{{ route('admin.gaming-platforms.create') }}">Create</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    @foreach ($platforms as $platform)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="status{{ $platform->id }}" name="status"
                                                        value="{{ $platform->id }}"
                                                        @if ($platform->status == 1) checked @endif
                                                        onchange="changeStatus(this.value)">
                                                    <label class="custom-control-label" for="status{{ $platform->id }}">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('admin.gaming-platforms.edit', $platform->id) }}"
                                                    class="btn btn-warning btn-sm waves-effect waves-light">Edit</a>
                                                <a href="#modal-delete" data-id="{{ $platform->id }}"  class="confirmDelete btn btn-sm btn-danger waves-effect waves-light" data-toggle="modal"
            ...
            <div class="modal-content">
                <form method="POST" action="" id="deleteForm">
                    ...
                    <div class="modal-body">
                        <p>You won't be able to revert this Gaming Platform once deleted!</p>
                    </div>
