...
@section('title', 'Bulk Emails')
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Bulk Emails</h2>
                </div>
            </div>
        </div>
            ...
            <div class="form-group breadcrum-right">
                <div class="dropdown">
                    <a class="btn btn-dark btn-md waves-effect waves-light"
                        href="{{ route('admin.bulk-emails.create') }}">Create</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    @foreach ($emails as $email)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#modal-delete" data-id="{{ $email->id }}"  class="confirmDelete btn btn-sm btn-danger waves-effect waves-light" data-toggle="modal"
            ...
            <div class="modal-content">
                <form method="POST" action="" id="deleteForm">
                    ...
                    <div class="modal-body">
                        <p>You won't be able to revert this Message once deleted!</p>
                    </div>
...
@push('scripts')
    ...
    <script>
        $(document).on("click", ".confirmDelete", function(e) {
            ...
            form_action = '{{ route('admin.bulk-emails.destroy', ':id') }}';
