            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ Auth::guard('admin')->user()->name }}</span><span class="user-status">Administrator</span></div><span><img class="round" src="{{  isset(Auth::guard('admin')->user()->avatar) ? asset('storage/uploads/admin/'.Auth::guard('admin')->user()->avatar) : asset('assets/images/profile/user-uploads/user-00.png') }}" alt="avatar" height="40" width="40"></span>
                        </a>
