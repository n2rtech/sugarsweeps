            ...
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <a href="{{ route('admin.players.create') }}" class="btn btn-gradient-dark">Create</a>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('admin.players.index') }}">
                            <div class="form-row">
                                ...
                                <div class="col-xl-2 col-md-12 text-right">
                                    ...
                                    <a href="{{ route('admin.players.index') }}" class="ms-btn-icon btn-gradient-warning form-control" type="submit"><i class="fas fa-undo"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
