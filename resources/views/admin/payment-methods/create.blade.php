    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Create Payment Method</h2>
                </div>
            </div>
        </div>
    </div>
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('admin.payment-methods.store') }}" method="POST" id="paymentForm">
                        @csrf
                ...
                <div class="card-footer text-right">
                    <button type="submit" class="btn btn-success" form="paymentForm">Save</button>
                </div>
            </div>
        </div>
    </div>
