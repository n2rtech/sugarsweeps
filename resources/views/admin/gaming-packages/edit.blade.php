...
@section('title', 'Edit Gaming Package')
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Edit Gaming Package</h2>
                </div>
            </div>
        </div>
    </div>
    <form action="{{ route('admin.gaming-packages.update', $package->id) }}" method="POST" id="gamingForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="{{ $platform->platform }} Username" name="{{  Str::lower(str_replace(' ', '', $platform->platform)) }}" value="{{ old(Str::lower(str_replace(' ', '', $platform->platform)), $platform->username) }}">
