            ...
            <nav aria-label="breadcrumb" class="ms-panel-custom">
                <ol class="breadcrumb pl-0">
                    <li class="breadcrumb-item" aria-current="page"> <a href="{{ route('admin.dashboard') }}"><i
                            ...
                            Dashboard</a></li>
                    <li class="breadcrumb-item"> <a href="{{ route('admin.redeem-requests.index') }}">Redeem Requests</a></li>
                ...
                <div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ route('admin.redeem-requests.index') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="ms-panel ms-widget bg-info" style="height: 326px;">
                                ...
                                <div class="ms-panel-body">
                                    <form method="POST" action="{{ route('admin.verify-request', $request->id) }}">
                                        @csrf
                                        @method('PUT')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="{{ route('admin.redeem.full') }}" class="pl-3 pr-3" id="approveAmount" method="POST">
                    @csrf
