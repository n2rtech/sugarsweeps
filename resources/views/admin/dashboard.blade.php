                                        ...
                                        @foreach ($players as $player)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($player->approved == '2')
                                                        <a href="{{ route('admin.players.credentials', $player->id) }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a href="#modal-delete" data-id="{{ $player->id }}"
                                                            data-toggle="modal" data-target="#modal-delete"
                                                            class="confirmDelete btn btn-sm btn-danger waves-effect waves-light">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="card">
                ...
                <div class="card-content">
                                    ...
                                    <tbody>
                                        @foreach ($approval_requests as $request)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <a href="{{ route('admin.approval-requests.show', $request->id) }}"
                    ...
                    @if (count($approval_requests) > 5)
                        <div class="card-footer text-center">
                            <a href="{{ route('admin.approval-requests.index') }}"
                                class="btn btn-outline-light square waves-effect waves-light">View All</a>
                        </div>
                    @endif
                </div>
