        ...
        <a href="{{route('admin.cashiers.index')}}">
            <div class="ms-card card-gradient-secondary ms-widget ms-infographics-widget" style="height: 103px;">
                <div class="ms-card-body media">
                    <div class="media-body">
                        <h6>Cashiers</h6>
                        <p class="ms-card-change">{{ $total_cashiers }}</p>
                    </div>
                </div>
            ...
            <div class="ms-panel-body">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <table class="table table-hover thead-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('admin.players.edit', $player->id) }}" class="ms-btn-icon btn-secondary"><i class="fas fa-pencil-alt ms-text-success"></i> </a>
                                            <a href="#modal-delete" data-id="{{ $player->id }}" class="confirmDelete ms-btn-icon btn-danger"
                        ...
                        <a href="{{ route('admin.players.index') }}" class="btn btn-warning btn-sm">View all</a>
                        </div>
                        @else
                        <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        @if (count($gaming_requests) > 0)
                            ...
                            <div class="col-md-12 text-center">
                                <a href="{{ route('admin.gaming-requests.index')}}" class="btn btn-sm btn-warning">View all</a>
                            </div>
                        @else
                            <div class="table-responsive">
                                <p class="text-center">No Listing found.</p>
        ...
        <div class="ms-panel">
            ...
            <div class="ms-panel-body">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        <a href="{{ route('admin.redeem-requests.index')}}" class="btn btn-sm btn-warning">View all</a>
                    </div>
                @else
                    <div class="table-responsive">
                        <p class="text-center">No Listing found.</p>
