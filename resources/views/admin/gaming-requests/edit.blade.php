            ...
            <nav aria-label="breadcrumb" class="ms-panel-custom">
                <ol class="breadcrumb pl-0">
                    <li class="breadcrumb-item" aria-current="page"> <a href="#"><i class="material-icons">home</i>
                            Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.gaming-requests.index') }}">Gaming Requests</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="ms-panel ms-widget ms-identifier-widget bg-warning">
                                ...
                                <div class="ms-panel-body">
                                        <table class="table table-bordered bg-white">
                                            <form method="POST" action="{{route('admin.gaming-requests.update', $request->id)}}" id="requestForm">
                                                @csrf
                                                @method('PUT')
                                        <tbody>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($other_requests as $request)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.gaming-requests.edit', $request->id) }}"
