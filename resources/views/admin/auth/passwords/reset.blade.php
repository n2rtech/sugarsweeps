...
<head>
    ...
    <meta name="description"
        content="Reset Password | Admin">
    <meta name="keywords"
        content="Admin Reset Password">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{ asset('assets/images/pages/reset-password.png') }}" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Please enter and confirm your new Password.</p>
